...
<head>
	...
	<title>RKSD Car Rental | Admin Manage Pages</title>
...
?>
											...
											<div class="form-group">
												...
												<button type="submit" name="submit" value="Update" id="submit" class="btn-primary btn" style="font-size: 20px">Update</button>
												</div>
											</div>
