...
<head>
	...
	<title>RKSD Car Rental | Admin Post Vehicle</title>
...
<body>
	...
	<?php include('includes/bodycolor.php');?>
	<div class="ts-main-content">
	<?php include('includes/leftbar.php');?>
	<?php include('includes/buttoncolor.php');?>
...
<label for="leatherseats"> Leather Seats </label>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<br><br>
													<button class="btn btn-primary" type="reset" style="font-size: 20px">Cancel</button>
													&nbsp;&nbsp;&nbsp;&nbsp;
													<button class="btn btn-primary" name="submit" type="submit" style="font-size: 20px">Save Changes</button>
												</div>
											</div>
