...
<head>
	...
	<title>RKSD Car Rental | Admin Edit Vehicle</title>
...
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%; font-size: 20px">Save Changes</button>
												</div>
											</div>
