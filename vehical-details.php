...
<title>RKSD Car Rental | Vehicle Details</title>
<!--Bootstrap -->
...
<section id="listing_img_slider">
  ...
  <div>
    <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" class="img-responsive" alt="image" width="900" height="560"></div>
  <div>
    <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" class="img-responsive" alt="image" width="900" height="560"></div>
  <div>
    <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" class="img-responsive"  alt="image" width="900" height="560"></div>
...
<!--Trace User's Activity-->
<?php include('includes/activity-log.php');?>
<!--/Trace User's Activity-->
