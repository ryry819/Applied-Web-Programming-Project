        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="newsletter-form">
            ...
            <p class="subscribed-text">*We send great deals and latest auto news to our subscribed users every week.</p>
              ...
              <div class="col-md-3 col-sm-6">
                <img src="qr-code.php" id="qrcode" style=" display: block; margin-left: auto; margin-right: auto; width: 80%">
                <script>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; <script type="text/javascript">
  document.write(new Date().getFullYear());
</script> RKSD Car Rental. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </div>
